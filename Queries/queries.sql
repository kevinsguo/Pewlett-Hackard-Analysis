...
-- Create Employee Information (containing employees' employee number, first/last name, gender, salary)
SELECT * FROM salaries
...
-- Create Management (Employee number, first name, last name, starting/ending employment dates)
...
-- Creating table for employee in Sales team (Employee number, Employee first/last name, employee department name)
